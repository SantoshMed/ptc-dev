...
function initBookmarkData(numChapters, callback) {
  ...
  _cmiData.studentName = doLMSGetValue("cmi.core.student_name");
  if(_cmiData.studentName == "") _cmiData.studentName = doLMSGetValue("cmi.core.student_id");
...
function scormcurrentFrame() {  
  _cmiData.lessonLocation = currentFrame+"";
